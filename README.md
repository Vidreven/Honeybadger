Java library for creating and signing Bitcoin transactions based on [Nayuki's Bitcoin cryptography library](https://github.com/nayuki/Bitcoin-Cryptography-Library)
